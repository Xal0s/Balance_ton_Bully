...
<!--<script src="../js/scriptHeaderNav.js" ></script>-->    <div class="container my-5">
                    ...
                    <div class="card-body blue-bg p-4 shadow-lg rounded text-white">
                        ...
                        <form method="post" class="mt-4">
                            <div class="form-group">
                               ...
                               <input type="email" id="mail" class="form-control my-2" name="mailRetrieve" placeholder="Entrez votre mail...">
                            ...
                            <div class="row gy-4 gy-md-0">
                                ...
                                <div class="col-xs-12 col-md-5 order-0 order-md-1">
                                    <ul class="nav justify-content-center justify-content-md-end" style="--bs-nav-link-padding-x: .8rem;">
                                        <li class="nav-item">
                                            <a class="nav-link link-dark" href="https://www.facebook.com/profile.php?id=61557832331708&is_tour_dismissed">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link link-dark" href="https://twitter.com/BalanceTonBully">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link link-dark" href="https://www.instagram.com/balancetonbully/">
...
<script src="../js/scriptFooter.js" ></script></body>
</html>